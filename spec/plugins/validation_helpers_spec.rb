...
RSpec.shared_examples "validation helper that accepts custom error messsage" do |method_name, input_value, *args|
  it "uses specified message instead of default one" do
    validation.validate { |i| i.params(:test) { |t| t.public_send("validate_#{method_name}", *args, message: "custom message") } }
...
RSpec.describe "validation helpers plugin" do
  ...
  describe "#absence" do
    before { validation.validate { |i| i.params(:test) { |test| test.validate_absence } } }
  ...
  describe "#acceptance" do
    before { validation.validate { |i| i.params(:test) { |test| test.validate_acceptance } } }
    ...
    context "when :as option is passed" do
      it "checks if value matches the one/s passed as :as option" do
        validation.validate { |i| i.params(:test) { |t| t.validate_acceptance as: ["accepted", "accept"] } }
  ...
  describe "#validate_equality" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_equality "equal" } } }
  ...
  describe "#validate_exact_length" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_exact_length 4 } } }
  ...
  describe "#validate_exclusion" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_exclusion %w(test retest overtest) } } }
  ...
  describe "#validate_format" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_format(/\A[a-z0-9][-a-z0-9]{1,19}\z/i) } } }
  ...
  describe "#validate_greater_than" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_greater_than 4 } } }
  ...
  describe "#validate_greater_than_or_equal_to" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_gteq 4 } } }
    ...
    it "is aliased as #validate_gteq" do
      input = validation::Param.new(:input, {})
      expect(input.method(:validate_gteq)).to eq(input.method(:validate_greater_than_or_equal_to))
    end
  end

  describe "#validate_inclusion" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_inclusion %w(test retest overtest) } } }
  ...
  describe "#validate_length_range" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_length_range 3..5 } } }
  ...
  describe "#validate_less_than" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_less_than 4 } } }
  ...
  describe "#less_than_or_equal_to" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_lteq 4 } } }
  ...
  describe "#validate_max_length" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_max_length 4 } } }
  ...
  describe "#min_length" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_min_length 4 } } }
  ...
  describe "#presence" do
    before { validation.validate { |i| i.params(:test) { |t| t.validate_presence } } }
    ...
    describe "when value is of specified type" do
      it "does not append errors" do
        [:integer, :Integer, Integer, "integer", "Integer"].each do |type_ref|
          validation.validate { |i| i.params(:test) { |t| t.validate_type type_ref } }
  ...
  describe ":default_messages option" do
    ...
    let(:validation) do
      Class.new(Fend) do
        validate do |i|
          i.params(:absence)                  { |p| p.validate_absence }
          i.params(:acceptance)               { |p| p.validate_acceptance }
          i.params(:equality)                 { |p| p.validate_equality "EQUAL" }
          i.params(:exact_length)             { |p| p.validate_exact_length 1 }
          i.params(:exclusion)                { |p| p.validate_exclusion ["NOPE"] }
          i.params(:format)                   { |p| p.validate_format(/\A(valid)\z/i) }
          i.params(:greater_than)             { |p| p.validate_greater_than 100 }
          i.params(:greater_than_or_equal_to) { |p| p.validate_gteq 100 }
          i.params(:inclusion)                { |p| p.validate_inclusion [true, false] }
          i.params(:length_range)             { |p| p.validate_length_range 99..100 }
          i.params(:less_than)                { |p| p.validate_less_than 2 }
          i.params(:less_than_or_equal_to)    { |p| p.validate_lteq 2 }
          i.params(:max_length)               { |p| p.validate_max_length 2 }
          i.params(:min_length)               { |p| p.validate_min_length 100 }
          i.params(:presence)                 { |p| p.validate_presence }
          i.params(:type)                     { |p| p.validate_type :integer }
        end
      end
    end
